...
<div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom">
    <h4 class="mb-0"><i class="bi bi-calendar-plus me-2"></i>학사 일정 등록</h4>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form id="scheduleInsertForm" action="${pageContext.request.contextPath}/schedule/insert.do"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" value="${schedule.title}"
                       class="form-control" placeholder="일정 제목을 입력하세요" required maxlength="200">
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="scheduleType" id="scheduleType" class="form-select" required>
                    <option value="일반"  ${schedule.scheduleType == '일반'  || schedule.scheduleType == null ? 'selected' : ''}>일반</option>
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" class="form-control" rows="8"
                          placeholder="일정 내용을 입력하세요 (선택사항)">${schedule.content}</textarea>
            </div>
